...
import { ItemCard, LoadingItemCard } from "./WardrobeItemCard";
...
const AsideClothingPickerSection = ({
  ...
  return (
    <section className="flex flex-col lg:flex-1 bg-surface px-5 lg:rounded-2xl w-full lg:max-w-[75%] h-[65vh] lg:max-h-[530px] overflow-y-scroll scrollbar-thin-gray">
      {ClothesLoading ? (
      ...
      {ClothesLoading ? (
        <div className="gap-6 grid grid-cols-[repeat(auto-fit,minmax(250px,1fr))] px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
