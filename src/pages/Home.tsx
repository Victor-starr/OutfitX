...
export default function Home() {
  return (
    <main className="top-0 relative w-screen h-screen">
      <header className="relative flex flex-col justify-center items-center px-4 sm:px-8 lg:px-12 w-full min-h-screen hero-banner">
        ...
        <div className="z-10 flex flex-col items-center mx-auto max-w-4xl text-center">
          <h1 className="mb-6 font-bold text-title text-4xl sm:text-5xl lg:text-6xl">
            Outfit <span className="text-primary">X</span>
          </h1>
          <p className="mb-8 max-w-2xl text-muted text-lg sm:text-xl lg:text-2xl leading-relaxed">
            OutfitX helps you organize your clothes, create and customize
            outfits, and manage your wardrobe in one simple app.
          </p>
          <div className="flex sm:flex-row flex-col justify-center items-center gap-4 sm:gap-6 w-full max-w-md">
            <Button
              type="v1"
              color="secondary"
              size="lg"
      ...
      <section className="flex lg:flex-row flex-col justify-center lg:justify-between items-center gap-8 lg:gap-12 bg-surface px-4 sm:px-8 lg:px-16 py-16 lg:py-20 w-full">
        <div className="w-full lg:w-2/5 max-w-2xl lg:text-left text-center">
          <h2 className="mb-6 font-bold text-title text-3xl sm:text-4xl lg:text-5xl">
            About OutfitX
          </h2>
          <p className="text-muted text-lg sm:text-xl lg:text-2xl leading-relaxed">
      ...
      <section className="flex flex-col items-center bg-bg px-4 sm:px-8 py-16 sm:py-20 w-full">
        <h1 className="mb-12 sm:mb-16 font-bold text-title text-3xl sm:text-4xl text-center">
          Why OutfitX?
        </h1>
        <div className="flex flex-wrap justify-center items-stretch gap-6 sm:gap-8 w-full max-w-7xl">
          {benefitsList.map((benefit, index) => (
            <article
              key={index}
              className="flex flex-col sm:flex-1 items-center bg-card hover:shadow-lg p-6 sm:p-8 rounded-2xl w-full sm:min-w-80 sm:max-w-sm text-center hover:scale-105 transition-all duration-300"
            >
              <div className="bg-primary/10 mb-4 sm:mb-6 p-4 sm:p-6 rounded-full">
                {benefit.icon}
              </div>
              <h2 className="mb-3 sm:mb-4 font-semibold text-title text-lg sm:text-xl">
                {benefit.title}
              </h2>
      ...
      <section className="flex flex-col justify-center items-center bg-surface px-8 py-20 w-full">
        <div className="bg-card p-8 rounded-2xl w-full max-w-lg">
